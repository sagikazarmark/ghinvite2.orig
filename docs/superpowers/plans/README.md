...
| 2 | **GitHub clients** | `2026-05-04-ghinvite-github-clients.md` | Written (no autoplan yet) | `crates/github` — user-OAuth client (oauth2 crate), installation-token client (JWT signing + token cache), HMAC verification helper, mock transport for tests | 1 |
