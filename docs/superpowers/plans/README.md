...
| 4 | **Web binary core** | `2026-05-04-ghinvite-web-binary.md` | Written | `crates/web` skeleton — axum app, tower-sessions, OAuth login + install flow, three Dioxus layouts (Home / Dashboard / Invitation), Tailwind+DaisyUI build, home page | 1, 2 |
