...
**Target architecture update (2026-09-24):** [ADR 0009](0009-canonical-link-identity-and-request-owned-lifecycle.md) consolidates create and settlement under one repository-delivery owner and removes projected approval from execution. The identity, uncertainty, and HTTP-attempt-fence policies in this ADR remain in force.
