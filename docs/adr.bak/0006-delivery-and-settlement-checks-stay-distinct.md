...
**Target architecture update (2026-09-24):** [ADR 0009](0009-canonical-link-identity-and-request-owned-lifecycle.md) permits replacing the separate `GithubCreate`/`GithubInvitation` registrations and SQL-derived settlement context in a clean prelaunch cutover. The distinct evidence and prerequisite meanings below remain required inside the unified owner.
