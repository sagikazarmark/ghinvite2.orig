...
**Target architecture update (2026-09-24):** [ADR 0009](0009-canonical-link-identity-and-request-owned-lifecycle.md) removes `InvitationCode` routing and moves request lifecycle commands to their request owner. Concrete web modules over Restate ingress remain the interface; the assembled acceptance path will also exercise the real owners.
