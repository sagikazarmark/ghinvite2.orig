...
use ghinvite_web::commands::{DecideInvitationRequest, InvitationRequestDecisionView};
...
fn external_command_implementations_can_inspect_approve_decisions() {
    ...
    let command = DecideInvitationRequest::approve(ghinvite_core::RequestId::new(), 7, decided_at);
